...
public class GenerationJavaCode {
	...
	static {
		...
		fileNameArray[6][0] = "html.ftl";
		fileNameArray[6][1] = "Index.html";
	}


	public GenerationJavaCode(String url, String name, String passWord, String driver, String tableName,
	                          String autoGeneratedFile, String basePath, String upClassName, String lowClassName, String chineseName, String searchCondition, String idx, String typeid) {
		this.idx = idx;
		this.typeid = typeid;
...
//设置模板文件路径
		...
		rootMap.put("ajaxErrorInfo", "${ajaxErrorInfo}");
...
//		List<Col> list = getColumnList();
		...
		//是否加排序字段 没有就为NUll
		rootMap.put("idx", idx);
		rootMap.put("typeid", typeid);

		for (String[] aFileNameArray : fileNameArray) {
			String packageName = null;
			String filePath = null;
			//设定包名
			switch (aFileNameArray[0]) {
				case "bean.ftl":
			...
			Template temp = cfg.getTemplate(aFileNameArray[0]);

			File docFile = new File(filePath + "//" + upClassName + aFileNameArray[1]);
