package allen.interview.templet.service;
...
public interface AppAnimalClassifyService {
	...
	public AjaxResponse changeDisableAppAnimalClassifyById(Integer id, boolean isDisable, Integer updateUserId) throws Exception;
