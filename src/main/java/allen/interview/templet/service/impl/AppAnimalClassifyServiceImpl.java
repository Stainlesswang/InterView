package allen.interview.templet.service.impl;
...
public class AppAnimalClassifyServiceImpl implements AppAnimalClassifyService {
	...
	public AjaxResponse addAppAnimalClassify(AppAnimalClassifyBean bean, Integer userId) throws Exception {
		if (AppAnimalClassifyBean.MAX_COUNT <= appAnimalClassifyDao.getCountAppAnimalClassify(null)) {
			return AlertMessage.getActionResponse("msgAppAnimalClassifyTen");
		}
		if (StringUtils.isEmpty(bean.getShwname())) {
			return AlertMessage.getActionResponse("msgAppAnimalClassifyNameIsNull");
		}
		List<AppAnimalClassifyBean> dbCustomerBean = appAnimalClassifyDao.searchAppAnimalClassifyByName(bean.getShwname());
		if (null != dbCustomerBean && dbCustomerBean.size() > 0) {
			return AlertMessage.getActionResponse("msgAppAnimalClassifyIsExist");
		}
	...
	public AjaxResponse deleteAppAnimalClassifyById(Integer id, Integer updateUserId) throws Exception {
		...
		if (null == dbBean) {
			return AlertMessage.getActionResponse("msgAppAnimalClassifyNotExist");
		}
	...
	public AjaxResponse updateAppAnimalClassifyById(AppAnimalClassifyBean bean, Integer userId) throws Exception {
		...
		AppAnimalClassifyBean dbBean = appAnimalClassifyDao.getAppAnimalClassifyById(bean.getShwid());
		if (null == dbBean) {
			return AlertMessage.getActionResponse("msgAppAnimalClassifyNotExist");
		}
		if (dbBean.getIsdisable() == AppAnimalClassifyBean.DISABLED) {
			return AlertMessage.getActionResponse("msgAppAnimalClassifyIsDisabled");
		}
		if (!dbBean.getShwname().equals(bean.getShwname())) {
			List<AppAnimalClassifyBean> dbCustomerBean = appAnimalClassifyDao.searchAppAnimalClassifyByName(bean.getShwname());
			if (null != dbCustomerBean && dbCustomerBean.size() > 0) {
				return AlertMessage.getActionResponse("msgAppAnimalClassifyIsExist");
			}
		}
		dbBean.setShwname(bean.getShwname());
